<html>
    ...
    <h1><center>ADD NEW STUDENT</center></h1>
        ...
        <div class="roll">
            ROLL NUMBER: &nbsp;&nbsp;
            &nbsp;&nbsp;<input type="text" name="rollno" value="IIITU173" name="rollno" onFocus="field_focus(this, 'rollno');" onblur="field_blur(this, 'rollno');" class="rollno">
           ...
           <br><br>
            ...
            <br>
            <br>
            <!--:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="names" value="" class="rollno">
            ...
            <br>
            <br>
            NAME:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="names" value="" class="rollno"><br>
            <br>
            NAME:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="names" value="" class="rollno">
            -->
